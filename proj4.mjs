 ...
 * @return {array} 0：日本測地系の経度 １:日本測地系の緯度
 **/
function world2japan(lat, lon) { 
  const ll =  proj4("EPSG:4326", "EPSG:4301", [lon, lat]);
  return [ll[1], ll[0]];
}

// test
/*
const ans = tokyo2world(135.0, 40);
console.log(ans[0], ans[1]);
const ans2 = world2tokyo(ans[0], ans[1]);
console.log(ans2);
*/

export { japan2world, world2japan };
